...
const TableContainer = ({
  ...
  const rowsShown = currentData.length;
      ...
      <Row className="align-items-center mt-2 g-3 text-center text-sm-start">
        <div className="col-sm">
          <div className="text-muted">
            Affichage de <span className="fw-semibold ms-1">{rowsShown}</span>{" "}
            résultats sur <span className="fw-semibold">{data.length}</span>{" "}
          </div>
        </div>
