...
import { Card, CardBody, CardHeader, Col, FormGroup, Container, DropdownItem, DropdownMenu, DropdownToggle, Input, Label, Nav, NavItem, NavLink, Pagination, PaginationItem, PaginationLink, Progress, Row, TabContent, Table, TabPane, UncontrolledCollapse, UncontrolledDropdown, Button } from 'reactstrap';
                                ...
                                <div className="d-flex">
                                    <Nav pills className="animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1"
                                        ...
                                        <NavItem>
                                            ...
                                            >
                                                <i className="ri-list-unordered d-inline-block d-md-none"></i> <span
                                                    className="d-none d-md-inline-block">Booking</span>
                                            </NavLink>
                                        </NavItem>
                                    </Nav>
                                    {roles && roles.includes("AGENCY") && (
                                                    ...
                                                    <Col lg={12}>
                                                        <Card>
                                                            <CardHeader className="align-items-center d-flex card-header-dark">
                                                                <h3 style={{ color: 'black' }}>Video Showcase</h3>
                                                                {roles && roles.includes("AGENCY") && (
                                                                    <div className="ms-auto">
                                                                        <FaUpload style={{ color: 'black', cursor: 'pointer' }} onClick={() => setShowVideoInput(!showVideoInput)} />
                                                                        {showVideoInput && (
                                                                            <FormGroup>
                                                                                <Label for="videoUpload" style={{ color: 'black' }}>Upload Video</Label>
                                                                                <Input
                                                                                    type="file"
                                                                                    name="file"
                                                                                    id="videoUpload"
                                                                        ...
                                                                        {videoFile && (
                                                                            <div style={{ marginTop: '10px' }}>
                                                                                <p style={{ color: 'black' }}>Video selected: {videoFile.name}</p>
                                                        ...
                                                        <Card style={{ marginBottom: '1rem', boxShadow: '0 0.125rem 0.25rem rgba(0, 0, 0, 0.075)' }}>
                                                            <CardHeader style={{ backgroundColor: '#f8f9fa', color: '#343a40', borderBottom: '1px solid #dee2e6' }} className="align-items-center d-flex">
                                                                <h3 className="mb-0" style={{ color: 'black' }}>Photo Gallery</h3>
                                                                {roles && roles.includes("AGENCY") && (
                                                                    <div className="ms-auto">
                                                                        <FaUpload style={{ color: 'black', cursor: 'pointer' }} onClick={() => setShowPhotoInput(!showPhotoInput)} />
                                                                        {showPhotoInput && (
                                                                            <FormGroup>
                                                                                <Label for="photoUpload" style={{ color: 'black' }}>Upload Photos</Label>
                                                                                <Input
                                                                                    type="file"
                                                                                    accept=".jpg,.jpeg,.png"
                                                                                    multiple
                                                                        ...
                                                                        {photoFiles.length > 0 && (
                                                                            <div style={{ marginTop: '10px' }}>
                                                                                <p style={{ color: 'black' }}>{photoFiles.length} photo(s) selected</p>
