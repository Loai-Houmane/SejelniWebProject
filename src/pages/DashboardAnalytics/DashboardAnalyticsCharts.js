...
const UsersByDeviceCharts = ({ dataColors, series }) => {
    ...
    const options = {
        labels: ["PENDING", "APPROVED", "REJECTED", "SUSPENDED"], // Updated labels
        chart: {
            type: "donut",
            height: 219,
        },
...
export { AudiencesCharts, AudiencesSessionsCharts, CountriesCharts, UsersByDeviceCharts, SalesForecastCharts };